...
<html class="wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page text-center">
                  ...
                  <div class="rd-navbar-nav-wrap">
                    <div class="rd-navbar-mobile-scroll">
                      ...
                      <ul class="rd-navbar-nav">
                        ...
                        <li class="active"><a href="contacts.php"><span>Contacts</span></a>
                        </li>
                      </ul>
                    </div>
                  </div>
      ...
      <!-- Get In Touch-->
      <section class="section-110 novi-background" data-preset='{"title":"Contact form 2","category":"content, form","reload":true,"id":"contact-form-2"}'>
        <div class="container">
            ...
            <div class="col-md-9 col-lg-8 col-xl-12">
              <div class="row">
                ...
                <div class="col-xl-4 text-left offset-top-66 offset-xl-top-0 inset-xl-left-80">
                  ...
                  <div class="offset-top-20"><span class="icon novi-icon icon-xxs mdi mdi-cellphone-android text-middle text-info inset-right-10"></span><a class="text-middle p" href="tel:#">1-800-1234-567</a></div>
                  <div class="offset-top-66">
                    <h5>Address</h5>
                  </div>
                  <div class="offset-top-14 text-subline offset-top-10"></div>
                  <div class="unit flex-row unit-spacing-xxs offset-top-20">
                    <div class="unit-left"><span class="icon novi-icon icon-xxs mdi mdi-map-marker text-middle text-info inset-right-10"></span></div>
                    <div class="unit-body"><a class="text-middle p" href="#">4578 Marmora St, San Francisco D04 89GR</a></div>
                  </div>
                  <div class="offset-top-66">
                    <h5>Open hours</h5>
                  </div>
                  <div class="offset-top-14 text-subline offset-top-10"></div>
                  <div class="unit flex-row unit-spacing-xxs offset-top-20">
                    <div class="unit-left"><span class="icon novi-icon icon-xxs mdi mdi-clock text-middle text-info inset-right-10"></span></div>
                    <div class="unit-body">
                      <div>
                  ...
                  <div class="text-center offset-top-66 inset-xl-right-50"><a class="btn d-xl-block btn-primary" href="schedule.php">BOOK AN APPOINTMENT</a></div>
                </div>
              </div>
            </div>
          </div>
