        ...
        <div class="rd-navbar-inner">
          ...
          ?>
              <div class="rd-navbar-top-panel">
                <div class="left-side">
                  <ul class="list-inline list-inline-sm list-inline-white text-darker">
                    <li class="list-inline-item"><a class="text-dark novi-icon fa fa-facebook" href="<?php echo $fs['facebook']; ?>"></a></li>
                    <li class="list-inline-item"><a class="text-dark novi-icon fa fa-twitter" href="<?php echo $fs['twitter']; ?>"></a></li>
                    <li class="list-inline-item"><a class="text-dark novi-icon fa fa-google-plus" href="<?php echo $fs['google']; ?>"></a></li>
                    <li class="list-inline-item"><a class="text-dark novi-icon fa fa-youtube" href="<?php echo $fs['linkedin']; ?>"></a></li>

                  </ul>
                </div>
                <div class="center">
                  <address class="contact-info text-left"><span><span class="icon mdi mdi-map-marker novi-icon"></span><a class="text-middle p text-dark" href="#"><?php echo $fs['direccion']; ?></a></span></address>
                </div>
              ...
              <div class="rd-navbar-panel">
                ...
                <!--Navbar Brand-->
                <div class="rd-navbar-brand"><a href="index.php"><img width='200' height='40' src='images/<?php echo $fs['logo']; ?>' alt='' /></a></div>
              </div>
